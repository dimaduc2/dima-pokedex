...
//Phần 3: các Function
  ...
  render() {
    const {favPokemon, Pokedex, removeFromFavourites, removeAllFromFavourites, selectPokemon2, comparePokemon1, 
            comparePokemon2, comPokemon1, comPokemon2, typesInfo, addToFavourites, deletePoke1, hoiCoXoaKhong} = this.props;
                  ...
                  <Card raised>
                    ...
                    <Popup
                      ...
                      <Popup.Content>
                        ...
                        addToFavourites={addToFavourites} deletePoke1={deletePoke1} hoiCoXoaKhong={hoiCoXoaKhong} />
                      </Popup.Content>
                    </Popup>
                    ...
                    <Card.Content extra>
                      <Button basic color='red' onClick = {() => this.props.hoiCoXoaKhong(moiTen)}>
                        <Icon name='star' />Removes
                      </Button>
                    </Card.Content>
                  </Card>
                </Grid.Column>
